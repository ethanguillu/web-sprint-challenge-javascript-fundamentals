...
// The functions can reach out for variables but can not reach in for variables
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(animalArray){
    ...
    animalArray.forEach(element => {newArray.push(`name: ${element.animal_name}, scientific: ${element.scientific_name}`)}); 
  ...
  */
  ...
  function lowerCaseNames(array){
    ...
    newerArray = array.map(element => element.animal_name.toLowerCase());
  ...
  */
  ...
  function USApop(zooAnimals){
   ...
   return zooAnimals.reduce((pValue, cValue) => {
      return pValue + cValue.population
   }, 0); 
